...
public class ClinicalTrialsDataExtractor {
	...
	public ClinicalTrialStaging convertXmlToStudyObject(ClinicalTrialXml clinicalTrialXml) {
		...
		if (clinicalTrialXml.getResponsibleParty().getResponsiblePartyType().equals("Principal Investigator") && clinicalTrialXml.getResponsibleParty().getInvestigatorAffiliation().contains("Emory")) {
